...
class RadioSettingsController {
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['networkId'] TODO: type description here
     * @param {CreateNetworkWirelessRfProfileModel} input['createNetworkWirelessRfProfile'] TODO:
     * type
     * descrip
     * tion
     * here
     ...
     * @returns {Promise}
     */
    static createNetworkWirelessRfProfile(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.createNetworkWirelessRfProfile === null || input.createNetworkWirelessRfProfile === undefined) {
            const _err = { errorMessage: 'The property `createNetworkWirelessRfProfile` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.createNetworkWirelessRfProfile),
        };
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['rfProfileId'] TODO: type description here
     * @param {UpdateNetworkWirelessRfProfileModel} input['updateNetworkWirelessRfProfile'] (option
     * al)
     * TODO:
     * type
     * descrip
     ...
     * @returns {Promise}
     */
    static updateNetworkWirelessRfProfile(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.rfProfileId === null || input.rfProfileId === undefined) {
            const _err = { errorMessage: 'The property `rfProfileId` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkWirelessRfProfile),
        };
     ...
     * @returns {Promise}
     */
    static deleteNetworkWirelessRfProfile(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static getNetworkWirelessRfProfile(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
