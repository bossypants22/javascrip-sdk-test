...
class FirewalledServicesController {
     ...
     * @param {string} input['service'] TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static getNetworkFirewalledService(input, callback) {
        ...
        } else if (input.service === null || input.service === undefined) {
            const _err = { errorMessage: 'The property `service` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['service'] TODO: type description here
     * @param {UpdateNetworkFirewalledServiceModel} input['updateNetworkFirewalledService'] (option
     * al)
     * TODO:
     * type
     * descrip
     ...
     * @returns {Promise}
     */
    static updateNetworkFirewalledService(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkFirewalledService),
        };
