...
class DevicesController {
     ...
     * @returns {Promise}
     */
    static getOrganizationDevices(input, callback) {
     ...
     * @returns {Promise}
     */
    static getNetworkDeviceUplink(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static removeNetworkDevice(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static rebootNetworkDevice(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/networks/{networkId}/devices/{serial}/reboot';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            networkId: input.networkId,
            serial: input.serial,
     ...
     * @returns {Promise}
     */
    static getNetworkDevicePerformance(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['serial'] TODO: type description here
     * @param {BlinkNetworkDeviceLedsModel} input['blinkNetworkDeviceLeds'] (optional) TODO: type
     * description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static blinkNetworkDeviceLeds(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/networks/{networkId}/devices/{serial}/blinkLeds';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            networkId: input.networkId,
            serial: input.serial,
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.blinkNetworkDeviceLeds),
        };
     ...
     * @returns {Promise}
     */
    static getNetworkDevice(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['networkId'] TODO: type description here
     * @param {ClaimNetworkDevicesModel} input['claimNetworkDevices'] TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static claimNetworkDevices(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.claimNetworkDevices === null || input.claimNetworkDevices === undefined) {
            const _err = { errorMessage: 'The property `claimNetworkDevices` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.claimNetworkDevices),
        };
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['serial'] TODO: type description here
     * @param {string} input['timespan'] (optional) The timespan for which LLDP and CDP information
     * will be fetched. Must be in seconds and less than or equal
     * to a month (2592000 seconds). LLDP and CDP information is
     * sent to the Meraki dashboard every 10 minutes. In
     * instances where this LLDP and CDP information matches an
     * existing entry in the Meraki dashboard, the data is
     * updated once every two hours. Meraki recommends querying
     * LLDP and CDP information at an interval slightly greater
     * than two hours, to ensure that unchanged CDP / LLDP
     * information can be queried consistently.
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static getNetworkDeviceLldpCdp(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['serial'] TODO: type description here
     * @param {UpdateNetworkDeviceModel} input['updateNetworkDevice'] (optional) TODO: type
     * description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateNetworkDevice(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkDevice),
        };
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['serial'] TODO: type description here
     * @param {string} input['ip'] The destination IP used to obtain the requested stats. This is
     * required.
     ...
     * The valid resolutions are: 60, 600, 3600, 86400. The
     * default is 60.
     * @param {string} input['uplink'] (optional) The WAN uplink used to obtain the requested stats.
     ...
     * @returns {Promise}
     */
    static getNetworkDeviceLossAndLatencyHistory(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.ip === null || input.ip === undefined) {
            const _err = { errorMessage: 'The property `ip` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
