...
class DevicesController {
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['serial'] TODO: type description here
     * @param {int} input['timespan'] (optional) The timespan for which LLDP and CDP information
     ...
     * default is 60.
     * @param {UplinkEnum} input['uplink'] (optional) The WAN uplink used to obtain the requested
     * stats. Valid uplinks are wan1, wan2, cellular. The
     * default is wan1.
     *
     * @callback    The callback function that returns response from the API call
     *
    ...
    static getNetworkDeviceLossAndLatencyHistory(input, callback) {
        ...
        _queryBuilder = _apiHelper.appendUrlWithQueryParameters(_queryBuilder, {
            ...
            uplink: (input.uplink !== null) ? input.uplink : null,
        });
