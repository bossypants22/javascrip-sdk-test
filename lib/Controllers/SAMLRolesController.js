...
class SAMLRolesController {
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['organizationId'] TODO: type description here
     * @param {CreateOrganizationSamlRoleModel} input['createOrganizationSamlRole'] (optional) TODO:
     * type
     * description
     * here
     *
     ...
     * @returns {Promise}
     */
    static createOrganizationSamlRole(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.createOrganizationSamlRole),
        };
