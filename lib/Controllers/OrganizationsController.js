...
class OrganizationsController {
     ...
     *
     * @param {CreateOrganizationModel} createOrganization TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
    ...
    static createOrganization(createOrganization, callback) {
        ...
        if (createOrganization === null || createOrganization === undefined) {
            const _err = { errorMessage: 'The parameter `createOrganization` is a required parameter and cannot be null.',
                errorCode: -1 };
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['organizationId'] TODO: type description here
     * @param {CloneOrganizationModel} input['cloneOrganization'] TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
    ...
    static cloneOrganization(input, callback) {
        ...
        if (input.organizationId === null || input.organizationId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.cloneOrganization === null || input.cloneOrganization === undefined) {
            const _err = { errorMessage: 'The property `cloneOrganization` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @returns {Promise}
     */
    static getOrganizationDeviceStatuses(organizationId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/organizations/{organizationId}/deviceStatuses';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            organizationId,
        });
     ...
     * @returns {Promise}
     */
    static getOrganizationInventory(organizationId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/organizations/{organizationId}/inventory';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            organizationId,
        });
     ...
     * @returns {Promise}
     */
    static getOrganizationLicenseState(organizationId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/organizations/{organizationId}/licenseState';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            organizationId,
        });
     ...
     * @param {UplinkEnum} input['uplink'] (optional) Optional filter for a specific WAN uplink.
     * Valid uplinks are wan1, wan2, cellular. Default will
     * return all uplinks.
