...
class AdminsController {
     ...
     * @param {UpdateOrganizationAdminModel} input['updateOrganizationAdmin'] (optional) TODO: type
     * description here
     *
     ...
     * @returns {Promise}
     */
    static updateOrganizationAdmin(input, callback) {
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateOrganizationAdmin),
        };
     ...
     * @returns {Promise}
     */
    static deleteOrganizationAdmin(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['organizationId'] TODO: type description here
     * @param {CreateOrganizationAdminModel} input['createOrganizationAdmin'] TODO: type
     * description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createOrganizationAdmin(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        if (input.organizationId === null || input.organizationId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.createOrganizationAdmin === null || input.createOrganizationAdmin === undefined) {
            const _err = { errorMessage: 'The property `createOrganizationAdmin` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.createOrganizationAdmin),
        };
