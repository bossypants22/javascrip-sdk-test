...
class BluetoothClientsController {
     ...
     * maximum lookback period is 7 days from today.
     ...
     * The value must be in seconds and be less than or equal to 7
     ...
     * the first, last, prev, or next page in the HTTP Link
     * header should define it.
     * @param {bool} input['includeConnectivityHistory'] (optional) Include the connectivity
     ...
     * @param {bool} input['includeConnectivityHistory'] (optional) Include the connectivity
     * history for this client
     * @param {int} input['connectivityHistoryTimespan'] (optional) The timespan, in seconds, for
     * the connectivityHistory data. By default 1
     * day, 86400, will be used.
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
