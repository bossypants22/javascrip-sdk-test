...
class NetworksController {
     ...
     * @param {CombineOrganizationNetworksModel} input['combineOrganizationNetworks'] TODO: type
     * description
     * here
     *
     * @callback    The callback function that returns response from the API call
     ...
     * @returns {Promise}
     */
    static combineOrganizationNetworks(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        if (input.organizationId === null || input.organizationId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.combineOrganizationNetworks === null || input.combineOrganizationNetworks === undefined) {
            const _err = { errorMessage: 'The property `combineOrganizationNetworks` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.combineOrganizationNetworks),
        };
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['organizationId'] TODO: type description here
     * @param {CreateOrganizationNetworkModel} input['createOrganizationNetwork'] TODO: type
     * description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createOrganizationNetwork(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        if (input.organizationId === null || input.organizationId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.createOrganizationNetwork === null || input.createOrganizationNetwork === undefined) {
            const _err = { errorMessage: 'The property `createOrganizationNetwork` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.createOrganizationNetwork),
        };
     ...
     * @returns {Promise}
     */
    static bindNetwork(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
