...
class SNMPSettingsController {
     ...
     * @returns {Promise}
     */
    static getNetworkSnmpSettings(networkId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/networks/{networkId}/snmpSettings';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            networkId,
        });
     ...
     * @param {UpdateNetworkSnmpSettingsModel} input['updateNetworkSnmpSettings'] (optional) TODO:
     * type description
     * here
     *
     * @callback    The callback function that returns response from the API call
     ...
     * @returns {Promise}
     */
    static updateNetworkSnmpSettings(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkSnmpSettings),
        };
...
module.exports = SNMPSettingsController;
