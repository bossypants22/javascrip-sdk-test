...
/**
 * Creates an instance of CreateNetworkSmProfileUmbrellaModel
 */
class CreateNetworkSmProfileUmbrellaModel extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'providerBundleIdentifier', realName: 'ProviderBundleIdentifier' },
            {
                ...
                realName: 'ProviderConfiguration',
                array: true,
...
module.exports = CreateNetworkSmProfileUmbrellaModel;
