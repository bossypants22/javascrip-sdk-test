...
/**
 * Creates an instance of CreateNetworkSmProfileClarityModel
 */
class CreateNetworkSmProfileClarityModel extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            {
                name: 'vendorConfig',
                realName: 'VendorConfig',
                array: true,
                type: 'VendorConfigModel',
            },
...
module.exports = CreateNetworkSmProfileClarityModel;
